...
public class PhoneCode {
    ...
    public static void main(String[] args) {
        String phone = "15952170286"; //此处可输入你的手机号码进行测试
        //获取验证码
        code = vcode();
     ...
     * @return
     */
    public static void getPhonemsg(String mobile, String code,JSONObject json) {
        /**
         * 进行正则关系校验
         */
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-xuzhou",
                accessKeyId, accessKeySecret);
        try {
            DefaultProfile.addEndpoint("cn-xuzhou", "cn-xuzhou", product,
                    domain);
        ...
        try {
            ...
            if (sendSmsResponse.getCode() != null
                ...
                json.put("status",sendSmsResponse.getCode());
            }
        } catch (ServerException e) {
            e.printStackTrace();
            json.put("msg","由于系统维护，暂时无法注册！！！");
            json.put("status","-2");
